...
def storyboard_generator(script: str, num_scenes: int = 5) -> str:
    ...
    resp = llm.invoke(f"""
You are a professional video director. Split this script into exactly {num_scenes} scenes.
...
STEP 1: Call storyboard_generator with the script and the num_scenes value from the user settings.
